...
public class facultynoti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facultynoti);
        name=getIntent().getStringExtra("name");
        if (getIntent().hasExtra("category")){
            Intent intent = new Intent(facultynoti.this,ReceiveNotificationActivity.class);
